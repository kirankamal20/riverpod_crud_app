...
import 'package:riverpod_crud_app/features/data_sync/view/data_sync_button.dart';
...
class _HomePageState extends ConsumerState<HomePage> with GlobalHelper {
  bool isDark = false;
        ...
        return Scaffold(
          ...
          body: Consumer(
            builder: (BuildContext context, WidgetRef ref, __) {
              final getAllStudents = ref.watch(getallStudentsNotifier);
                          ...
                          RefreshIndicator(
                            ...
                            child: GridView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return CustomCard(student: student);
